            ...
            try:
                ...
                if hit:
                    if parry:
                        if choice == 1:
                            sw.print_slow(
                                f"{self.name} attacked {Target.name} but {Target.name} parried your attack!"
                            )
                            damage = self.basicATK // 2
                        elif choice == 2:
                            if self.pp1 != 0:
                                sw.print_slow(
                                    f"{self.name} used {self.move1_name} on {Target.name}  but {Target.name} parried your attack!"
                                )
                                damage = self.Move1 // 2
                                self.pp1 -= 1
                            else:
                            ...
                            if self.pp2 != 0:
                                sw.print_slow(
                                    f"{self.name} used {self.move2_name} on {Target.name}  but {Target.name} parried your attack!"
                                )
                                damage = self.Move2 // 2
                                self.pp2 -= 1
                            else:
                            ...
                            if self.pp3 != 0:
                                sw.print_slow(
                                    f"{self.name} used {self.move3_name} on {Target.name}  but {Target.name} parried your attack!"
                                )
                                damage = self.Move3 // 2
                                self.pp3 -= 1
                            else:
                        ...
                        if choice == 1:
                            ...
                            if self.pp1 != 0:
                                sw.print_slow(
                                    f"{self.name} used {self.move1_name} on {Target.name} !"
                                )
                                print("CRITICAL HIT!")
                                damage = self.Move1 * 2
                                self.pp1 -= 1
                            ...
                            if self.pp2 != 0:
                                sw.print_slow(
                                    f"{self.name} used {self.move2_name} on {Target.name}!"
                                )
                                print("CRITICAL HIT!")
                                damage = self.Move2 * 2
                            else:
                            ...
                            if self.pp3 != 0:
                                sw.print_slow(
                                    f"{self.name} used {self.move3_name} on {Target.name}!"
                                )
                                print("CRITICAL HIT!")
                                damage = self.Move3 * 2
                                self.pp3 -= 1
